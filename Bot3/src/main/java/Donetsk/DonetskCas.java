...
public class DonetskCas{
        private static Document document;

        public static String[] getDonetkCas(String period) {



            if (period.equals("Подробнее \ud83c\udf86")) {
                try {
                    document = Jsoup.connect("https://world-weather.ru/pogoda/ukraine/donetsk/24hours/").get();
